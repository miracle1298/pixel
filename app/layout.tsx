  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta
          name="fc:miniapp"
          content='{"version":"1","imageUrl":"http://localhost:3000/api/embed-image","button":{"title":"Start Game","action":{"type":"launch_miniapp","name":"Battle Game","url":"http://localhost:3000","splashImageUrl":"http://localhost:3000/api/splash","splashBackgroundColor":"#1a1a1a"}}}'
        />
        <meta
          name="fc:frame"
          content='{"version":"1","imageUrl":"http://localhost:3000/api/embed-image","button":{"title":"Start Game","action":{"type":"launch_frame","name":"Battle Game","url":"http://localhost:3000","splashImageUrl":"http://localhost:3000/api/splash","splashBackgroundColor":"#1a1a1a"}}}'
        />
